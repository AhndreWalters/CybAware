            ...
            <div class="about-container">
                <div class="about-section">
                    <div class="about-text">
                        ...
                        <p>Please read these terms and conditions carefully before using this site. These terms tell you the rules for using CybAware, available at our website.</p>
                        ...
                        <p>To contact us, please email <a href="mailto:cybaware@proton.me" style="color: #1e40af; font-weight: 600;">cybaware@proton.me</a></p>
                        ...
                        <h2>We are not responsible for external websites</h2>
                        ...
                        <h2>Security and Responsible Use</h2>
                        ...
                        <p>You may use our site only for lawful educational purposes. You may not use our site:</p>
                        <ul style="margin-left: 20px; margin-bottom: 20px; line-height: 1.6;">
                            ...
                            <li>To knowingly transmit any data containing viruses or harmful programs</li>
                        </ul>
                        
                        <h3>Breach of this policy</h3>
                        <p>When we consider that a breach of this acceptable use policy has occurred, we may take such action as we deem appropriate, including:</p>
                        <ul style="margin-left: 20px; margin-bottom: 20px; line-height: 1.6;">
                            <li>Immediate withdrawal of your right to use our site</li>
                            <li>Legal proceedings against you for reimbursement of costs</li>
                            <li>Disclosure of such information to authorities as required by law</li>
                        </ul>
                        ...
                        <p style="margin-top: 30px; font-style: italic;">These terms are based on standard educational project terms and have been adapted for the CybAware cybersecurity awareness project.</p>
                    </div>
                </div>
            </div>
        </div>
